...
export default function Mint(){
	...
	const totalMinted = totalSupply ? totalSupply.toString() : '0';
    ...
    return(
        <div>
			...
			{isConfirmed && <p className='mt-3 text-green-500'>You have claimed successfully</p>}
			{isConfirming && <p className='mt-3 text-blue-500'>Confirming...</p>}
			{isTxPending && <p className='mt-3 text-blue-500'>Confirm on your wallet</p>}
			{!isConfirmed && !isConfirming && !isTxPending && <p className='mt-3 text-gray-500'>Plese click on claim to mint</p>}
